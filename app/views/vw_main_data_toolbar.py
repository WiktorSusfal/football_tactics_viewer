...
OBJECT_BUTTON_NAME  = 'MAIN_DATA_TOOLBAR_BUTTON'
OBJECT_TITLE_LABEL_NAME = 'MAIN_DATA_TOOLBAR_TITLE_LABEL'
...
class VwMainDataToolbar(VWBaseView):
    ...
    def __init__(self, model: VmdCurrentDataset = None, parent=None):
        ...
        self._b_refresh     = self._produce_button(tooltip='Refresh Data'    , button_name=OBJECT_BUTTON_NAME, icon_rel_path=r'refresh24.png', icon_size=32)
        self._b_recalculate = self._produce_button(tooltip='Recalculate Data', button_name=OBJECT_BUTTON_NAME, icon_rel_path=r'calculate64.png', icon_size=32)
